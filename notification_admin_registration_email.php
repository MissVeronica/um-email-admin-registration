...
<div style="max-width: 560px;padding: 20px;background: #ffffff;border-radius: 5px;margin:40px auto;font-family: Open Sans,Helvetica,Arial;font-size: 15px;color: #666;">
	...
	<div style="padding: 0 30px 30px 30px;border-bottom: 3px solid #eeeeee;">
		...
		<div style="padding: 30px 0;font-size: 24px;text-align: center;line-height: 40px;">We have registered an account for you {display_name} at our site {site_name} and your username is {username}.<span style="display: block;">Your account is now active.</span></div>
